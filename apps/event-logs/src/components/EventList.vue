...
<template>
  <div class="overflow-y-auto">
    <div
      ...
      :key="event.id"
      class="grid grid-cols-[100px_200px_100px_200px_1fr] gap-4border-b border-base-200 last:border-b-0 cursor-pointer hover:bg-base-200/50 transition-colors"
    >
    ...
    <JsonModal :is-open="isModalOpen" :raw-data="selectedEvent" @close="closeModal" />
  </div>
</template>
