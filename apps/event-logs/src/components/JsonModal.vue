...
<template>
  <dialog class="modal" :class="{ 'modal-open': isOpen }">
    <div class="modal-box border-2 border-base-200 overflow-hidden w-11/12 max-w-400">
      ...
      <JsonEditor :value="rawData" :readOnly="true" :tree-show-values="true" :tree-show-counts="true"
        :editorShowCounts="true" :editor-show-descriptions="true" :sidebar-open="true" :height="680" :style="{
